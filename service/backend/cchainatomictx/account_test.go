...
func TestAccountBalance(t *testing.T) {
	...
	t.Run("C-chain atomic tx balance is sum of UTXOs", func(t *testing.T) {
		...
		assert.Equal(t, cconstants.AvaxCurrency, resp.Balances[0].Currency)
...
func TestAccountCoins(t *testing.T) {
	...
	t.Run("C-chain atomic tx coins returns UTXOs", func(t *testing.T) {
		...
		assert.Equal(t, cconstants.AvaxCurrency, resp.Coins[0].Amount.Currency)
		...
		assert.Equal(t, cconstants.AvaxCurrency, resp.Coins[1].Amount.Currency)
		...
		assert.Equal(t, cconstants.AvaxCurrency, resp.Coins[2].Amount.Currency)
