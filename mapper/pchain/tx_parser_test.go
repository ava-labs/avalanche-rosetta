...
func TestMapAddValidatorTx(t *testing.T) {
	...
	cntTxType, cntInputMeta, cntOutputMeta, cntMetaType := verifyRosettaTransaction(rosettaTransaction.Operations, pconstants.AddValidator, pconstants.Stake.String())
...
func TestMapAddDelegatorTx(t *testing.T) {
	...
	cntTxType, cntInputMeta, cntOutputMeta, cntMetaType := verifyRosettaTransaction(rosettaTransaction.Operations, pconstants.AddDelegator, pconstants.Stake.String())
...
func TestMapImportTx(t *testing.T) {
	...
	cntTxType, cntInputMeta, cntOutputMeta, cntMetaType := verifyRosettaTransaction(rosettaTransaction.Operations, pconstants.ImportAvax, pconstants.Import.String())
...
func TestMapExportTx(t *testing.T) {
	...
	cntTxType, cntInputMeta, cntOutputMeta, cntMetaType := verifyRosettaTransaction(rosettaTransaction.Operations, pconstants.ExportAvax, pconstants.Export.String())
...
func verifyRosettaTransaction(operations []*types.Operation, txType pconstants.TxType, metaType string) (int, int, int, int) {
	cntOpInputMeta := 0
	cntOpOutputMeta := 0
	cntTxType := 0
	cntMetaType := 0
