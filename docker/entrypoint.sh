...
export AVALANCHEGO_RPC_ENDPOINT=${AVALANCHEGO_RPC_ENDPOINT:-"http://localhost:9650"}
export AVALANCHEGO_INDEXER_ENDPOINT=${AVALANCHEGO_INDEXER_ENDPOINT:-$AVALANCHEGO_RPC_ENDPOINT}
...
{
  "mode": "$AVALANCHE_MODE",
  "rpc_endpoint": "$AVALANCHEGO_RPC_ENDPOINT",
  "indexer_endpoint": "$AVALANCHEGO_INDEXER_ENDPOINT",
