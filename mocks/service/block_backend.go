...
func (_m *BlockBackend) Block(ctx context.Context, request *types.BlockRequest) (*types.BlockResponse, *types.Error) {
	...
	var r1 *types.Error
	if rf, ok := ret.Get(0).(func(context.Context, *types.BlockRequest) (*types.BlockResponse, *types.Error)); ok {
...
func (_m *BlockBackend) BlockTransaction(ctx context.Context, request *types.BlockTransactionRequest) (*types.BlockTransactionResponse, *types.Error) {
	...
	var r1 *types.Error
	if rf, ok := ret.Get(0).(func(context.Context, *types.BlockTransactionRequest) (*types.BlockTransactionResponse, *types.Error)); ok {
		return rf(ctx, request)
	}
...
type mockConstructorTestingTNewBlockBackend interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewBlockBackend(t mockConstructorTestingTNewBlockBackend) *BlockBackend {
	mock := &BlockBackend{}
	mock.Mock.Test(t)
