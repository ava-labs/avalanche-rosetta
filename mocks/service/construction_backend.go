...
func (_m *ConstructionBackend) ConstructionCombine(ctx context.Context, req *types.ConstructionCombineRequest) (*types.ConstructionCombineResponse, *types.Error) {
	...
	var r1 *types.Error
	if rf, ok := ret.Get(0).(func(context.Context, *types.ConstructionCombineRequest) (*types.ConstructionCombineResponse, *types.Error)); ok {
		return rf(ctx, req)
	}
...
func (_m *ConstructionBackend) ConstructionDerive(ctx context.Context, req *types.ConstructionDeriveRequest) (*types.ConstructionDeriveResponse, *types.Error) {
	...
	var r1 *types.Error
	if rf, ok := ret.Get(0).(func(context.Context, *types.ConstructionDeriveRequest) (*types.ConstructionDeriveResponse, *types.Error)); ok {
		return rf(ctx, req)
	}
...
func (_m *ConstructionBackend) ConstructionHash(ctx context.Context, req *types.ConstructionHashRequest) (*types.TransactionIdentifierResponse, *types.Error) {
	...
	var r1 *types.Error
	if rf, ok := ret.Get(0).(func(context.Context, *types.ConstructionHashRequest) (*types.TransactionIdentifierResponse, *types.Error)); ok {
		return rf(ctx, req)
	}
...
func (_m *ConstructionBackend) ConstructionMetadata(ctx context.Context, req *types.ConstructionMetadataRequest) (*types.ConstructionMetadataResponse, *types.Error) {
	...
	var r1 *types.Error
	if rf, ok := ret.Get(0).(func(context.Context, *types.ConstructionMetadataRequest) (*types.ConstructionMetadataResponse, *types.Error)); ok {
		return rf(ctx, req)
	}
...
func (_m *ConstructionBackend) ConstructionParse(ctx context.Context, req *types.ConstructionParseRequest) (*types.ConstructionParseResponse, *types.Error) {
	...
	var r1 *types.Error
	if rf, ok := ret.Get(0).(func(context.Context, *types.ConstructionParseRequest) (*types.ConstructionParseResponse, *types.Error)); ok {
		return rf(ctx, req)
	}
...
func (_m *ConstructionBackend) ConstructionPayloads(ctx context.Context, req *types.ConstructionPayloadsRequest) (*types.ConstructionPayloadsResponse, *types.Error) {
	...
	var r1 *types.Error
	if rf, ok := ret.Get(0).(func(context.Context, *types.ConstructionPayloadsRequest) (*types.ConstructionPayloadsResponse, *types.Error)); ok {
		return rf(ctx, req)
	}
...
func (_m *ConstructionBackend) ConstructionPreprocess(ctx context.Context, req *types.ConstructionPreprocessRequest) (*types.ConstructionPreprocessResponse, *types.Error) {
	...
	var r1 *types.Error
	if rf, ok := ret.Get(0).(func(context.Context, *types.ConstructionPreprocessRequest) (*types.ConstructionPreprocessResponse, *types.Error)); ok {
		return rf(ctx, req)
	}
...
func (_m *ConstructionBackend) ConstructionSubmit(ctx context.Context, req *types.ConstructionSubmitRequest) (*types.TransactionIdentifierResponse, *types.Error) {
	...
	var r0 *types.TransactionIdentifierResponse
	var r1 *types.Error
	if rf, ok := ret.Get(0).(func(context.Context, *types.ConstructionSubmitRequest) (*types.TransactionIdentifierResponse, *types.Error)); ok {
		return rf(ctx, req)
	}
...
type mockConstructorTestingTNewConstructionBackend interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewConstructionBackend(t mockConstructorTestingTNewConstructionBackend) *ConstructionBackend {
